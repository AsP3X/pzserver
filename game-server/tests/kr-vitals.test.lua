    ...
    return {
        ...
        getPrimaryHandItem = function()
            ...
            return {
                ...
                getCurrentAmmoCount = function() error("Tried to call nil") end,
                isRoundChambered = function() error("Tried to call nil") end,
                isJammed = function() error("Tried to call nil") end,
